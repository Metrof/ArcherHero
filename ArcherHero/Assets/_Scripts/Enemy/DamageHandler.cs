...
public static class DamageHandler
{
    ...
    private static readonly float[,] vulnerabilityMultipliers =
    {
        ...
        /* Default */        {  1.5f,    1.3f,  1.3f,   1.3f },
        /* FireArmor */      {  1.0f,    0.5f,  2.5f,   1.0f },
        /* IceArmor */       {  1.0f,    2.5f,  0.5f,   1.0f },
        /* RoboArmor */      {  1.0f,    1.0f,  1.0f,   2.5f }
    };

    public static int CalculateDamage(int damageAmount, DamageTypeExp damageType, ArmorTypeExp armorType)
    {
